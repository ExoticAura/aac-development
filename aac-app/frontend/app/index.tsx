...
const INITIAL_CATEGORY_VOCAB: Record<string, VocabTile[]> = {
  ...
  math: [
    { label: "0", say: "zero", color: "#FFE6B3" },
    { label: "1", say: "one", color: "#FFE6B3" },
    { label: "2", say: "two", color: "#FFE6B3" },
    { label: "3", say: "three", color: "#FFE6B3" },
    { label: "4", say: "four", color: "#FFE6B3" },
    { label: "5", say: "five", color: "#FFE6B3" },
    { label: "6", say: "six", color: "#FFE6B3" },
    { label: "7", say: "seven", color: "#FFE6B3" },
    { label: "8", say: "eight", color: "#FFE6B3" },
    { label: "9", say: "nine", color: "#FFE6B3" },
    ...
    { label: "plus", say: "plus", color: "#FFE6B3", icon: "add-circle" },
    { label: "minus", say: "minus", color: "#FFE6B3", icon: "remove-circle" },
    { label: "equals", say: "equals", color: "#FFE6B3", icon: "git-compare" },
    { label: "count", say: "count", color: "#FFE6B3", icon: "list" },
    { label: "more", say: "more", color: "#FFE6B3", icon: "arrow-up" },
    { label: "less", say: "less", color: "#FFE6B3", icon: "arrow-down" },
    { label: "same", say: "same", color: "#FFE6B3", icon: "repeat" },
    { label: "all", say: "all", color: "#FFE6B3", icon: "albums" },
    { label: "none", say: "none", color: "#FFE6B3", icon: "close-circle" },
    { label: "take away", say: "take away", color: "#FFE6B3", icon: "trash" },
    { label: "share", say: "share", color: "#FFE6B3", icon: "share-social" },
    { label: "group", say: "group", color: "#FFE6B3", icon: "people" },
    { label: "circle", say: "circle", color: "#FFE6B3", icon: "ellipse" },
    { label: "square", say: "square", color: "#FFE6B3", icon: "square" },
    { label: "triangle", say: "triangle", color: "#FFE6B3", icon: "triangle" },
